...
public class LifeView extends Frame {	
	...
	/** Skapar ett LifeView-fnster fr spelplanen board */
	...
	/** Ritar upp de fixa delarna av spelplanen (rutntet,
      generationsrknaren och knapparna) */
	public void drawBoard() {
		repaint();
	}

	/** Ritar om de delar av ritfnstret som ndrats sedan fregende uppritning */
	public void update() {
		repaint();
		for (int i = 0; i<rows; i++)
			for (int k = 0; k<cols; k++)
	...
	/** Vntar tills anvndaren klickar med musen. Ger:
      1: Klick i ruta på spelplanen. Index fr rutan kan hmtas med getRow
			och getCol
	...
	/** Tar reda på radnummer fr den klickade rutan efter kommando nr 1 */
	public int getRow() {
		return lastRow;
	}

	/** Tar reda på kolonnummer fr den klickade rutan efter kommando nr 1 */
	public int getCol() {
		return lastCol;
	}
